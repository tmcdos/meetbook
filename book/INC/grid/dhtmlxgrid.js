...
/*
	...
	*/
	this.setRowTextStyle=function(row_id, styleString){
		...
		for (var i = 0; i < r.childNodes.length; i++)
		{
  		...
  		r.childNodes[i].style.cssText=pfix+(r.childNodes[i].style.width!='' ? "width:"+r.childNodes[i].style.width+";" : '')+styleString;
		}
	}
	/**
	...
	*/
	this.setCellTextStyle=function(row_id, ind, styleString)
	{
		...
		if (!cell) return;
		var pfix = "";
		cell.style.cssText=pfix+(cell.style.width!='' ? "width:"+cell.style.width+";" : '')+styleString;
	}
